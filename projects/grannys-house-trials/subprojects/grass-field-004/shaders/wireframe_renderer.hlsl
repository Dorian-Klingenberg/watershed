...
struct VSOutput
{
    ...
    nointerpolation int cell_x : TEXCOORD2;
    nointerpolation int cell_z : TEXCOORD3;
};
...
VSOutput VSMain(uint vertex_id : SV_VertexID)
{
    ...
    output.material_id = cell.material_id;
...
float3 MaterialColor(uint material_id)
{
    switch (material_id)
    {
    case 6: return float3(0.18f, 0.62f, 1.0f);
    case 10: return float3(0.78f, 0.54f, 0.32f);
    case 11: return float3(0.62f, 0.62f, 0.54f);
    case 12: return float3(0.86f, 0.45f, 1.0f);
    case 13: return float3(0.64f, 0.94f, 0.58f);
    default: return float3(0.75f, 0.95f, 0.55f);
    }
}
